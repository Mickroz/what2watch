...
$lang = array_merge($lang, array(
	...
	'DEBUG_EXPLAIN' 				=> 'Check this box for debugging',
	...
	'LOG_FILESIZE'			=> 'Log Filesize',
	'LOG_FILESIZE_EXPLAIN'			=> 'Maximum filesize in Bytes for log files (1024 is 1MB)',
	...
	'PLUGINS'					=> 'Plugins',
	'PROCESSING_MOVIE'			=> '%s of %s movie(s) processed',
	'PROCESSING_SHOW'			=> '%s of %s show(s) processed',
	...
	'SKIP_INCOMPLETE'			=> 'Skip Incomplete Shows',
	'SKIP_INCOMPLETE_EXPLAIN'			=> 'Skip shows that are not fully collected yet <i>uses Trakt collection</i>.',
	'SKIP_NOT_WATCHED'			=> 'Skip Only not watched shows',
	'SKIP_NOT_WATCHED_EXPLAIN'			=> 'Skip only shows that are not watched yet <i>this overrules the option above</i>.',
	...
	'SOURCE'				=> 'Source',
	'START_SHOWS'			=> '################ Starting check for shows ################',
	...
	'SUCCESS'	=> 'Success',
	'TESTING' 				=> 'Testing',
	'TRAKT_CANCEL' 				=> 'cancelling previous checkin on trakt',
	'TRAKT_CHECKIN' 				=> 'Checked into %s on trakt',
	'TRAKT_CHECKIN_WAIT'		=> 'You are already checked into another episode or movie. Either override the previous check-in or wait %s and try again.',
	'TRAKT_ERROR' 				=> 'Communication with trakt is not possible, try again later.',
	'TRAKT_GET_COLLECTED' 				=> 'Trying to get collection for %s',
