...
$lang = array_merge($lang, array(
	...
	'DEBUG_EXPLAIN' 				=> 'Vink dit vakje aan om te debuggen',
	...
	'END_SHOWS'					=> '################ Einde controle voor series ################',
	'ERROR'						=> 'Error',
	...
	'INSTALL_DIR'			=> 'Installatie Locatie',
	'IP_SUBNET'				=> 'IP Subnet',
	...
	'LOG_FILESIZE'			=> 'Log Bestandsgrootte',
	'LOG_FILESIZE_EXPLAIN'			=> 'Maximale bestandsgrootte in bytes voor logbestanden (1024 is 1MB)',
	...
	'PLUGIN_INSTALL'			=> 'Installeer',
	'PLUGIN_INSTALL_EXIST'		=> 'Plugin reeds geïnstalleerd',
	'PLUGIN_INSTALL_SUCCESS'	=> '%s succesvol geïnstalleerd.',
	'PLUGIN_UNINSTALL'			=> 'Verwijderen',
	'PLUGIN_UNINSTALL_FAILED'	=> 'Kan %s niet vinden, al verwijderd??',
	'PLUGIN_UNINSTALL_SUCCESS'	=> '%s succesvol verwijderd.',
	'PLUGIN_SETTINGS_UPDATED'	=> '%s instellingen opgeslagen.',
	'PLUGINS'					=> 'Plugins',
	'PROCESSING_MOVIE'			=> '%s van %s film(s) verwerkt',
	'PROCESSING_SHOW'			=> '%s van %s serie(s) verwerkt',
	...
	'SKIP_INCOMPLETE'			=> 'Skip Incomplete Series',
	'SKIP_INCOMPLETE_EXPLAIN'			=> 'Skip series die nog niet compleet zijn <i>gebruikt Trakt collectie</i>.',
	'SKIP_NOT_WATCHED'			=> 'Skip alleen onbekeken',
	'SKIP_NOT_WATCHED_EXPLAIN'			=> 'Skip alleen series die nog niet bekeken zijn <i>dit overruled de optie hierboven</i>.',
	'SKIP_SHOWS' 				=> 'Skip Series',
	'SKIP_SHOWS_EXPLAIN' 				=> 'TVDB id\'s gescheiden door een , die je wenst <u>niet</u> te laten checken op ondertitels(shows in eigen taal bijvoorbeeld).',
	'SOURCE'				=> 'Source',
	'START_SHOWS'			=> '################ Start controle voor series ################',
	'STYLE_SELECT'			=> 'Style',
	'SUBMIT' 				=> 'Submit',
	...
	'SUCCESS'	=> 'Succes',
	'TESTING' 				=> 'Testing',
	'TRAKT_CANCEL' 				=> 'vorige aanmelding annuleren op trakt',
	'TRAKT_CHECKIN' 				=> 'aangemeld bij %s op trakt',
	'TRAKT_CHECKIN_WAIT'		=> 'U bent al aangemeld bij een andere aflevering of film. Overschrijf de vorige aanmelding of wacht %s en probeer het opnieuw.',
	'TRAKT_ERROR' 				=> 'Communicatie met trakt is niet mogenlijk, probeer het later nog eens.',
	'TRAKT_GET_COLLECTED' 				=> 'Probeer verzameling te krijgen voor %s',
	'TRAKT_GET_ID'				=> 'trakt id verkrijgen voor %s %dx%d',
